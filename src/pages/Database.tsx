  ...
  return (
    <div className={`container mx-auto max-w-7xl ${isMobile ? 'px-4 py-5 pt-16 pb-24' : 'px-6 py-8 pt-[72px]'}`}>
        ...
        <div className="bg-primary/5 p-3 rounded-xl border border-primary/10 mb-4">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm text-muted-foreground">
              {isVerifying ? "Verifica assegnabilità..." : "Aggiornamento dati..."}
            </p>
          </div>
        </div>
      )}
      ...
      <Tabs defaultValue="leads" className="w-full">
        <TabsList className={`grid w-full grid-cols-3 mb-4 rounded-xl ${isMobile ? 'text-xs' : ''}`}>
          <TabsTrigger value="leads" className="data-[state=active]:text-primary rounded-lg">
            Lead Generation
          </TabsTrigger>
          <TabsTrigger value="bookings" className="data-[state=active]:text-primary rounded-lg">
            Call Prenotate
          </TabsTrigger>
          <TabsTrigger value="lavorati" className="data-[state=active]:text-primary rounded-lg">
            Lead Lavorati
          </TabsTrigger>
        </TabsList>
